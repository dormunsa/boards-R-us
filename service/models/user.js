...
const user_schema = new mongoose.Schema({
    ...
    hasProfile:{type: Boolean, default: false ,required: false},
    isSigned:{type: Boolean, default: false ,required: false},
    ...
    topPicks: { type: [Object], required: false }, // array of top five snowboards id's that the system fit to the user
